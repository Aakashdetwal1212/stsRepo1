...
class IEmployeeRepositoryTest {
	  ...
	  @Test
	  public void seveEmployeeTest() {
	   
        Employee employee = repository.save(new Employee("piter", "parker", 1010, 27, "ratlam", 333999, "A+", new Date(), new Date()));	  
	  ...
	  public void findEmployeeByfirstNameTest() {
		  ...
		  Employee employee1 = repository.save(new Employee("piter", "parker", 1010, 27, "ratlam", 333999, "A+", new Date(), new Date()));	
	      Employee employee2 = repository.save(new Employee("jack", "john", 1020, 27, "ratlam", 333000, "A+", new Date(), new Date()));	
	  ...
	  public void updateById() {
          ...
          employeeNew.setDoj(employee.getDoj());
          employeeNew.setDob(employee.getDob());
